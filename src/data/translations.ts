...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    enableEnlargedText: "Enable Enlarged Text", // Changed from enableHighContrastMode
    enlargedTextDescription: "Increases the overall text size for better readability.", // Changed
    textSizeScaleLabel: "Text Size",
    textSizeScaleDescriptionHelp: "Adjust text size (80% to 200%). Current: {value}%",
    enableHighContrastMode: "Enable High Contrast Mode", // New translation key
    highContrastModeDescription: "Optimizes colors for higher contrast (feature in development).", // New
